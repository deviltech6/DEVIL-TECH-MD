...
cmd({
    ...
    try {
        ...
        const channelLink = "https://whatsapp.com/channel/0029Vb9u0GQ8qIzmoGPEtq0s";

        // Send the channel link to the user
        reply(`*ʜᴇʀᴇ's ᴛʜᴇ ʟɪɴᴋ ᴛᴏ ᴏᴜʀ ᴏғғɪᴄɪᴀʟ ᴡʜᴀᴛsᴀᴘᴘ ᴅᴇᴠɪʟ-ᴛᴇᴄʜ-ᴍᴅ ᴄʜᴀɴɴᴇʟ*:\n\n${channelLink}\n\n> *ᴊᴏɪɴ ᴜs ᴛᴏ sᴛᴀʏ ᴜᴘᴅᴀᴛᴇᴅ ᴡɪᴛʜ ᴛʜᴇ ʟᴀᴛᴇsᴛ ɴᴇᴡs ᴀɴᴅ ᴀɴɴᴏᴜɴᴄᴇᴍᴇɴᴛs🧞‍♂️.*`);
    } catch (error) {
...
cmd({
    ...
    try {
        ...
        const supportLink = "https://whatsapp.com/channel/0029Vb5FXZc11ulFjgqBPR09";
