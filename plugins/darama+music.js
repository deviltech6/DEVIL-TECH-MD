...
// SEND DOC TYPE
await conn.sendMessage(from, { document: { url: ytdl.download.url }, mimetype: "audio/mpeg", fileName: ytdl.result.title + '.mp3', caption: `> *© Pᴏᴡᴇʀᴇᴅ Bʏ Cʏʙᴇʀ Lᴏᴋᴜ Aꜱʜᴜᴜ ♡*` }, { quoted: mek })
