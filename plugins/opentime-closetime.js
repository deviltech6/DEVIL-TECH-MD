...
try{
        ...
        let adminTagMessage = '*╭┈───────────────•⟢* *│ᴅᴇᴠɪʟ ᴛᴇᴄʜ ᴍᴅ ᴛᴀɢɢɪɴɢ ᴀᴅᴍɪɴs°👑* *╰┈───────────────•⟢*\n\n';
...
if (!isBotAdmins) return reply(mg.needbotadmins);     
           ...
           const mass = await conn.sendMessage(m.chat, { text: '*GROUP CHAT MUTED BY DEVIL-TECH-MD* 🔒' }, { quoted: mek });
...
if (!isBotAdmins) return reply(mg.needbotadmins);     
           ...
           const mass = await conn.sendMessage(m.chat, { text: '*GROUP CHAT UNMUTED BY DEVIL-TECH-MD* 🔒' }, { quoted: mek });
            return await conn.sendMessage(m.chat, { react: { text: '🔒', key: mass.key } });
} catch(e) {
console.log(e);
reply('*BAKA! GIVE ME A ADDMIN ROLE❗👻*')    
